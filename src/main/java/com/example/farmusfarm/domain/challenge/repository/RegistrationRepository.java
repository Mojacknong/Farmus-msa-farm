...
public interface RegistrationRepository extends JpaRepository<Registration, Long> {
    ...
    @Query("select new com.example.farmusfarm.domain.challenge.dto.res.GetMyChallengeListDto(r.challenge.id, r.id, r.challenge.imageUrl, r.challenge.grayImage) from registration r where r.userId = :userId")
